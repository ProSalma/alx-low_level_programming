...
/**
 * print_data - Function  prints ELF data
 * @h: The ELF header struct
 */
...
/**
 * print_version - Function prints ELF version
 * @h: The ELF header struct
 */
...
/**
 * print_osabi - Function prints ELF osabi
 * @h: The ELF header struct
 */
...
/**
 * print_osabi_more - Function prints ELF osabi more
 * @h: The ELF header struct
 */
void print_osabi_more(Elf64_Ehdr h)
{
...
/**
 * print_abiversion  - Function prints ELF ABI version
 * @h: The ELF header struct
 */
...
/**
 * print_entry - Function prints the ELF entry point address
 * @h: The ELF header struct
 */
